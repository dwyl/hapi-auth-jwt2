...
internals.implementation = function (server, options) {
  ...
  return {
    authenticate: function (request, reply) {
      ...
      if(options.key && typeof options.validateFunc === 'function') {
      ...
      else if (typeof options.verifyFunc === 'function') { // see: https://github.com/dwyl/hapi-auth-jwt2/issues/130
        ...
        return reply(Boom.notImplemented('JWT validateFunc or verifyFunc required!', 'Token'), null, { credentials: decoded });
